...
public class PlayerCustomizer : MonoBehaviour
{
    ...
    public void ChangeFirstWeapon()
    {
        if (ItemsContainer.firstWeaponsList.Count() != 0)
        {
            ...
            Debug.Log(ItemsContainer.firstWeaponsList[firstWeaponIdx]);
            LoadWeapon(ItemsContainer.firstWeaponsList[firstWeaponIdx]);
    ...
    public void ChangeSecondWeapon()
    {
        if (ItemsContainer.secondWeaponsList.Count() != 0)
        {
            ...
            Debug.Log(ItemsContainer.secondWeaponsList[secondWeaponIdx]);
            LoadWeapon(ItemsContainer.secondWeaponsList[secondWeaponIdx]);
        }
        else
    ...
    private void LoadWeapon(CustomWeapon cw)
    {
        ...
        characterSkin.AddSkin(skeletonData.FindSkin(cw.skinName));
    ...
    private void LoadPlayerLoadout()
    {
        ...
        if (playerLoadout.firstWeapons.Count() != 0 /*&& firstWeaponIdx <= playerLoadout.firstWeapons.Count()*/)
        {
            ...
            {
                Debug.Log("playerLoadout.firstWeapons" + item.gunName);
            }
            return;
        }
        ...
        if (playerLoadout.secondWeapons.Count() != 0 /*&& secondWeaponIdx <= playerLoadout.secondWeapons.Count()*/)
        {
            ...
            {
                Debug.Log("playerLoadout.secondWeapons" + item.gunName);
            }
